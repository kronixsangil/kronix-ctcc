...
const emptyCreate: AdminCreateStoreInput & Record<string, any> = {
  ...
  lat: 0,
  lng: 0,
  mainEntranceLat: null,
  mainEntranceLng: null,
  pickupLat: null,
  pickupLng: null,
  category: "General",
  description: "",
  ...
  ownerEmail: "",
  storeType: "",
  affiliateStatus: "PENDING_VISIT",
  visitedAt: "",
  visitedBy: "",
  physicalDocumentsReceived: false,
  ...
  async function load() {
    ...
    try {
      ...
      setForm({
        ...
        ownerPhone: storeAny.ownerPhone ?? "",
        ownerEmail: storeAny.ownerEmail ?? "",
        storeType: storeAny.storeType ?? "",
        affiliateStatus: storeAny.affiliateStatus ?? "PENDING_VISIT",
        visitedAt: storeAny.visitedAt ? String(storeAny.visitedAt).slice(0, 10) : "",
        visitedBy: storeAny.visitedBy ?? "",
        physicalDocumentsReceived: Boolean(storeAny.physicalDocumentsReceived),
        documentsReviewed: Boolean(storeAny.documentsReviewed),
        documentsApproved: Boolean(storeAny.documentsApproved),
        contractSigned: Boolean(storeAny.contractSigned),
        approvedAt: storeAny.approvedAt ? String(storeAny.approvedAt).slice(0, 10) : "",
        approvedBy: storeAny.approvedBy ?? "",
        approvalNotes: storeAny.approvalNotes ?? "",
        onboardingNotes: storeAny.onboardingNotes ?? "",
        rejectedReason: storeAny.rejectedReason ?? "",
    ...
    try {
      ...
      if (mode === "create") {
        const created = await adminCreateStore({
          ...
          ownerDocument: nullableText(form.ownerDocument),
          ownerPhone: nullableText(form.ownerPhone),
          ownerEmail: nullableText(form.ownerEmail),
          storeType: nullableText(form.storeType),
          affiliateStatus: form.affiliateStatus || "PENDING_VISIT",
          visitedAt: nullableText(form.visitedAt),
          visitedBy: nullableText(form.visitedBy),
          physicalDocumentsReceived: Boolean(form.physicalDocumentsReceived),
          documentsReviewed: Boolean(form.documentsReviewed),
          documentsApproved: Boolean(form.documentsApproved),
          contractSigned: Boolean(form.contractSigned),
          approvedAt: nullableText(form.approvedAt),
          approvedBy: nullableText(form.approvedBy),
